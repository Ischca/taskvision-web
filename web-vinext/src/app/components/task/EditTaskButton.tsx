...
interface FirestoreTask
  extends Omit<Task, "date" | "deadline" | "repeatSettings"> {
...
const EditTaskButton: React.FC<EditTaskButtonProps> = ({
  ...
  function isTimestamp(value: unknown): value is Timestamp {
    return value !== null && typeof value === "object" && value !== undefined && "toDate" in value;
  }
  ...
  const handleUpdateTask = async () => {
    ...
    try {
      ...
      const updateData: Record<string, string | null> = {
        ...
        blockId:
          selectedBlock && selectedBlock.trim() !== "" ? selectedBlock : null,
      ...
      // Task update failed - error handling can be added here if needed
    } finally {
  ...
  return (
    <>
      <button
        ...
        title={t("common.actions.editTask")}
      >
