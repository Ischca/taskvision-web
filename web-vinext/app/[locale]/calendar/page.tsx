...
import { Task, Block } from "../../../src/types";
import Calendar from "../../../src/app/components/Calendar";
import TaskItem from "../../../src/app/components/TaskItem";
import UnassignedTasksSection from "../../../src/app/components/UnassignedTasksSection";
import {
  ArrowPathIcon,
  ChevronLeftIcon,
  ChevronRightIcon,
...
import { formatDate, parseDate, getMonthRange } from "../../../src/lib/dateUtils";
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1">
          <UnassignedTasksSection
            blocks={[]}
            tasks={tasks.filter(
              (task) => !task.date || (task.date && !task.blockId),
            )}
            loading={loading}
            date=""
          />
            ...
            {selectedDate ? (
              ...
              <div className="empty-state py-12">
                ...
                <h3 className="text-xl font-medium mb-2">
                  {t("calendar.selectDateMessage")}
                </h3>
                <p className="text-gray-500 dark:text-gray-400">
                  {t("calendar.selectDateDescription")}
                </p>
              </div>
            )}
          </div>
