      ...
      >
        <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700">
          <h3 className="text-lg font-bold text-gray-900 dark:text-white">
            {isEditing ? t("tasks.taskDetails") : t("tasks.taskDetails")}
          </h3>
          <button
        ...
        <form onSubmit={handleSubmit} className="p-4">
          <div className="space-y-4">
            ...
            <div className="space-y-4 mt-4">
              ...
              <div className="grid w-full items-center gap-1.5">
                <Label htmlFor="task-block">{t("tasks.block")}</Label>
                <Select value={selectedBlock} onValueChange={setSelectedBlock}>
                  <option value="">{t("tasks.selectBlock")}</option>
                  {blocks && blocks.length > 0 ? (
                    ...
                    <option value="no-blocks">{t("blocks.noBlocks")}</option>
                  )}
                </Select>
                {!selectedBlock && (
                  <div className="text-gray-500 text-xs mt-1">
                    {t("tasks.blockUnassignedNote")}
                  </div>
                )}
              </div>
            ...
            <div>
              ...
              >
                <div className="flex items-center">
                  ...
                  <span>
                    {showReminderSettings
                      ? t("tasks.hideReminderSettings")
                      : t("tasks.showReminderSettings")}
                  </span>
                </div>
                <ChevronDownIcon
                  className={`h-5 w-5 text-gray-400 transition-transform ${showReminderSettings ? "transform rotate-180" : ""}`}
                />
              </button>
            </div>
            ...
            <div>
              ...
              >
                <div className="flex items-center">
                  ...
                  <span>
                    {showRepeatSettings
                      ? t("tasks.hideRepeatSettings")
                      : t("tasks.showRepeatSettings")}
                  </span>
                </div>
                <ChevronDownIcon
                  className={`h-5 w-5 text-gray-400 transition-transform ${showRepeatSettings ? "transform rotate-180" : ""}`}
                />
              </button>
            </div>
